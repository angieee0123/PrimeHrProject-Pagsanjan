...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('leave_transactions', function (Blueprint $table) {
            ...
            $table->enum('transaction_type', ['credit', 'debit', 'pending', 'reversal', 'adjustment', 'leave_import', 'ledger_entry'])->comment('Type of transaction');
            ...
            $table->enum('reference_type', ['accrual', 'leave_application', 'manual_adjustment', 'carryover', 'initialization', 'leave_import', 'tardiness_deduction'])->comment('What triggered this transaction');
