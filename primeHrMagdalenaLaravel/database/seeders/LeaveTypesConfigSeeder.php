    ...
    public function run(): void
    {
        $leaveTypes = [
            ...
            [
                ...
                'attachment_info' => 'For employees who legally adopt a child. Adoption decree or certificate required.',
                'document_path' => null,
                'is_active' => true,
            ],
            ...
            // Magna Carta Leave for Women (MCL)
            [
                'leave_code' => 'MCL',
                ...
                'is_monetizable' => false,
                'requires_attachment' => false,
                'attachment_info' => 'For female employees under RA 9710. 2 months with full pay for gynecological disorders.',
                'document_path' => null,
                'is_active' => true,
            ],
            // Maternity Leave (ML)
            [
                ...
                'is_monetizable' => false,
                'requires_attachment' => true,
                'attachment_info' => 'Medical certificate, pregnancy test result, and birth certificate required. 105 days for live birth, 60 days for miscarriage.',
                'document_path' => null,
                'is_active' => true,
            ],
            ...
            // Parental Leave for Solo Parents (PLSP)
            [
                'leave_code' => 'PLSP',
                'leave_name' => 'Parental Leave for Solo Parents',
                'is_accrued' => false,
                'annual_limit' => 7.00,
                'is_cumulative' => false,
                'requires_6_months' => false,
                'is_monetizable' => false,
                'requires_attachment' => true,
                'attachment_info' => 'Additional to Solo Parent Leave. Valid Solo Parent ID required.',
                'document_path' => null,
                'is_active' => true,
            ],
            ...
            // Special Leave for Women Victims (SLWV)
            [
                'leave_code' => 'SLWV',
                'leave_name' => 'Special Leave for Women Victims',
                'is_accrued' => false,
                'annual_limit' => 10.00,
                'is_cumulative' => false,
                'requires_6_months' => false,
                'is_monetizable' => false,
                'requires_attachment' => true,
                'attachment_info' => 'For women victims of violence. Police report or barangay certificate required.',
                'document_path' => null,
                'is_active' => true,
            ],
            ...
            // Special Leave Privilege (SPL)
            [
                'leave_code' => 'SPL',
                'leave_name' => 'Special Leave Privilege',
                'is_accrued' => false,
                'annual_limit' => 3.00,
                'is_cumulative' => false,
                'requires_6_months' => true,
                'is_monetizable' => false,
                'requires_attachment' => false,
                'attachment_info' => 'For personal milestones (birthdays, weddings), filial obligations, or emergencies.',
                'document_path' => null,
                'is_active' => true,
            ],
            // Study Leave (STL)
            [
                ...
                'is_monetizable' => false,
                'requires_attachment' => true,
                'attachment_info' => 'Maximum 6 months. Requires approval from head of agency. Certificate of enrollment and course outline required.',
                'document_path' => null,
                'is_active' => true,
            ],
            // Terminal Leave (TL)
