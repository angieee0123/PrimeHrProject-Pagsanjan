...
class AttendanceController extends Controller
{
    ...
    {
        return $this->computation()->creditPassSlipGapMinutes($sessionStart, $sessionEnd, $realFrom, $realTo, $passSlipsForDate, $passSlipCompliance);
    }

    /**
     * The shared accreditation engine, also used by the attendance scanner.
     */
    private function computation(): AttendanceComputationService
    {
        return app(AttendanceComputationService::class);
    }
    ...
    {
        return $this->computation()->computeAccreditedHours($employeeId, $date, $amIn, $amOut, $pmIn, $pmOut, $otIn, $otOut, $passSlipsForDate);
    }
    ...
    {
        return $this->computation()->computeTotalHours($amIn, $amOut, $pmIn, $pmOut, $otIn, $otOut);
    }
