<x-topbar title="My Attendance">
    ...
    <x-slot:actions>
        <div class="topbar-search-wrap">
            ...
            <input type="text" id="employeeAttendanceSearch" class="topbar-search-input" placeholder="Search date or status..." oninput="filterPermanentAttendanceTable(this.value)">
        </div>
    </x-slot:actions>
</x-topbar>
