{{-- Payslip Modal --}}
@if($latestPayslip)
<x-modal id="payslipModal" close="closePayslipModal">
    <div class="modal-header">
        ...
        <button class="modal-close" onclick="closePayslipModal()">
    ...
    <div class="modal-footer">
        <button class="modal-btn-ghost" onclick="closePayslipModal()">Close</button>
