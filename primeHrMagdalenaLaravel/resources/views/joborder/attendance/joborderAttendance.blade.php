    ...
    <main class="main-content">
        ...
        <div style="background:linear-gradient(135deg,#fafafe 0%,#f7f6ff 100%);border:1.5px solid #e4e3f0;border-radius:12px;padding:20px 24px;margin-bottom:20px;display:flex;justify-content:space-between;align-items:center;box-shadow:0 1px 3px rgba(11,4,77,0.04);">
            ...
            <div style="text-align:center;flex:1;">
                ...
                <p style="font-size:20px;font-weight:700;color:#a16207;margin:0;line-height:1;">2</p>
            ...
            <div style="text-align:center;flex:1;">
                ...
                <p style="font-size:20px;font-weight:700;color:#0b044d;margin:0;line-height:1;">2.5</p>
                <p style="font-size:11px;font-weight:500;color:#9999bb;margin:4px 0 0;">hrs</p>
            </div>
            <div style="width:1px;height:40px;background:linear-gradient(to bottom,transparent,#e4e3f0,transparent);"></div>
            <div style="text-align:center;flex:1;">
                <p style="font-size:9.5px;font-weight:600;color:#9999bb;letter-spacing:1px;margin:0 0 8px;text-transform:uppercase;">Holidays</p>
                <p style="font-size:20px;font-weight:700;color:#0b044d;margin:0;line-height:1;">1</p>
                <p style="font-size:11px;font-weight:500;color:#9999bb;margin:4px 0 0;">day</p>
            </div>
        </div>
        ...
        <div class="table-section">
                ...
                <table class="payroll-table">
                    ...
                    <tbody>
                        ...
                        $records = [
                            ...
                            ['date'=>'Jun 17','day'=>'Tue','in'=>'8:10 AM','out'=>'5:00 PM','ot'=>'—','status'=>'late'],
                        ...
                        <tr>
                            ...
                            <td class="attendance-time-cell {{ $r['in'] === '—' ? 'attendance-muted' : 'attendance-dark' }}">{{ $r['in'] }}</td>
                            <td class="attendance-time-cell {{ $r['out'] === '—' ? 'attendance-muted' : 'attendance-dark' }}">{{ $r['out'] }}</td>
                            <td class="attendance-time-cell {{ $r['ot'] !== '—' ? 'attendance-dark attendance-semibold' : 'attendance-muted' }}">{{ $r['ot'] }}</td>
                            <td>
                                @if($r['status']==='present')
            ...
            <div class="table-footer">
                <span>Showing <strong>1–10</strong> of <strong>20</strong> records</span>
...
<div class="modal-overlay" id="dtrModal" style="display:none" onclick="closeModal('dtrModal')">
    <div class="modal-box" onclick="event.stopPropagation()">
        ...
        <div class="modal-body">
            ...
            <div class="modal-row"><span>Late Arrivals</span><strong>2 times</strong></div>
            <div class="modal-row"><span>Holidays</span><strong>1 day</strong></div>
            <div class="modal-section-label" style="margin-top:16px">OVERTIME</div>
            <div class="modal-row"><span>Total OT Hours</span><strong>2.5 hrs</strong></div>
...
.attendance-time-cell { font-size:13px; }
.attendance-muted { color:#9999bb; font-weight:400; }
.attendance-dark { color:#0b044d; }
.attendance-semibold { font-weight:600; }
</style>
