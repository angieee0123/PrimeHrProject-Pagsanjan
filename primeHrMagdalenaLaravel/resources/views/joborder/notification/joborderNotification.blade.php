<div class="notif-wrap">
    ...
    <div class="notif-panel" id="notifPanel">
        ...
        <div class="notif-body" id="notifBody">
            <div class="notif-card new" onclick="goToPage('{{ route('joborder.attendance') }}')">
            ...
            <div class="notif-card new" onclick="goToPage('{{ route('joborder.payslip') }}')">
                <div class="notif-left">
            ...
            <div class="notif-card" onclick="goToPage('{{ route('joborder.dashboard') }}')">
                <div class="notif-left">
