...
<div class="app-layout">
    ...
    <main class="main-content">
        ...
        @include('joborder.topbar.payslipTopbar')
        ...
        <div class="table-section">
            <div class="table-header">
                ...
                <div class="table-actions">
                    ...
                    <button type="button" class="modal-btn-primary js-open-payslip-modal" data-payslip-index="0">
                        ...
                        <tr>
                            <td>
                                <div style="display:flex;align-items:center;gap:8px">
                                    <div class="pay-period-dot {{ $p['latest'] ? 'pay-period-dot--latest' : '' }}" aria-hidden="true"></div>
                            ...
                            <td>
                                <button type="button" class="btn-view js-open-payslip-modal" data-payslip-index="{{ $p['idx'] }}">View</button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
...
.pay-period-dot { width:8px; height:8px; border-radius:50%; flex-shrink:0; background:#e4e3f0; }
.pay-period-dot--latest { background:#d9bb00; }
</style>
...
<script>
    ...
    document.querySelectorAll('.js-open-payslip-modal').forEach((btn) => {
        btn.addEventListener('click', () => {
            const i = parseInt(btn.dataset.payslipIndex, 10);
    ...
    function filterPayslipTable(query) {
