...
<div class="app-layout">
    ...
    <main class="main-content">
        ...
        @include('joborder.topbar.joborderTopbar')
        ...
        <div class="stats-grid stats-grid-4">
            ...
            <div class="stat-card">
                ...
                <p class="stat-value" style="font-size:20px">₱12,500.00</p>
            ...
            <div class="stat-card">
                ...
                <p class="stat-value" style="font-size:20px">₱11,250.00</p>
                <div class="stat-footer">
        ...
        <div class="table-section">
            ...
            <div class="table-wrapper">
                <table class="payroll-table">
                    ...
                    <tbody>
                        @php
                        $payslips = [
                            ['period'=>'Jun 16–30, 2025','basic'=>'₱12,500.00','deduct'=>'₱1,250.00','net'=>'₱11,250.00','date'=>'Jun 30, 2025','status'=>'pending'],
                            ['period'=>'Jun 1–15, 2025','basic'=>'₱12,500.00','deduct'=>'₱1,250.00','net'=>'₱11,250.00','date'=>'Jun 15, 2025','status'=>'processed'],
                            ['period'=>'May 16–31, 2025','basic'=>'₱12,500.00','deduct'=>'₱1,250.00','net'=>'₱11,250.00','date'=>'May 31, 2025','status'=>'processed'],
                            ['period'=>'May 1–15, 2025','basic'=>'₱12,500.00','deduct'=>'₱1,250.00','net'=>'₱11,250.00','date'=>'May 15, 2025','status'=>'processed'],
                            ['period'=>'Apr 16–30, 2025','basic'=>'₱12,500.00','deduct'=>'₱1,250.00','net'=>'₱11,250.00','date'=>'Apr 30, 2025','status'=>'processed'],
                        ];
                        @endphp
            ...
            <div class="table-footer">
                <span>Showing <strong>1–5</strong> of <strong>12</strong> payslips</span>
        ...
        <div class="bottom-row">
                ...
                <div class="table-wrapper">
                    <table class="payroll-table">
                        ...
                        <tbody>
                            @php
                            $notifs = [
                                ['title'=>'DTR Reminder','desc'=>'Please submit your daily time record for June 30, 2025.','time'=>'2 hours ago','status'=>'unread'],
                                ['title'=>'Payslip Available','desc'=>'Your payslip for Jun 1–15, 2025 is now available.','time'=>'Yesterday','status'=>'unread'],
                                ['title'=>'Contract Renewal','desc'=>'Your contract is up for renewal on Dec 31, 2025.','time'=>'2 days ago','status'=>'read'],
                            ];
                            @endphp
                            @foreach($notifs as $n)
                            <tr>
                                <td>
                                    <div style="display:flex;align-items:flex-start;gap:10px">
                                        <div class="notif-dot {{ $n['status']==='unread' ? 'notif-dot-unread' : 'notif-dot-read' }}"></div>
                                        <div>
            ...
            <div class="side-col">
                ...
                <div class="stat-card no-margin">
                    <p class="stat-label" style="margin-bottom:12px">Contract Info</p>
                    @php
                    $info = [
                        ['label'=>'Employment Type','value'=>'Job Order','color'=>'#0b044d'],
                        ['label'=>'Contract Start','value'=>'Jan 1, 2025','color'=>'#15803d'],
                        ['label'=>'Contract End','value'=>'Dec 31, 2025','color'=>'#a16207'],
                    ];
                    @endphp
                    @foreach($info as $i)
                    <div style="margin-bottom:10px">
                        <div style="display:flex;justify-content:space-between;font-size:12px;margin-bottom:4px">
                            <span style="font-weight:600;color:#9999bb">{{ $i['label'] }}</span>
                            <span class="contract-value
                                {{ $i['color'] === '#0b044d' ? 'contract-value-primary' : '' }}
                                {{ $i['color'] === '#15803d' ? 'contract-value-success' : '' }}
                                {{ $i['color'] === '#a16207' ? 'contract-value-warning' : '' }}
                            ">{{ $i['value'] }}</span>
                        </div>
                        <div style="height:1px;background:#f0effe;border-radius:99px"></div>
                    </div>
                    @endforeach
                </div>
...
<div class="modal-overlay" id="payslipModal" style="display:none" onclick="closeModal('payslipModal')">
    <div class="modal-box" onclick="event.stopPropagation()">
        ...
        <div class="modal-body">
            ...
            <div class="modal-row total"><span>Total Deductions</span><span class="modal-deduct">₱1,250.00</span></div>
...
.quick-action-btn:hover { border-color:#15803d; }
...
.notif-dot-unread { background:#d9bb00; }
.notif-dot-read { background:#e5e4f0; }
.contract-value { font-weight:700; }
.contract-value-primary { color:#0b044d; }
.contract-value-success { color:#15803d; }
.contract-value-warning { color:#a16207; }
</style>
...
@include('joborder.chatbot.joborderChatbot')
