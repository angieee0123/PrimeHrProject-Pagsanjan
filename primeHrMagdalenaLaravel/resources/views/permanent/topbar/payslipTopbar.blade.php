...
<div class="welcome-banner">
    ...
    <div class="banner-right">
        <div class="topbar-search-wrap">
            ...
            <input type="text" id="permanentPayslipSearch" class="topbar-search-input" placeholder="Search period or status..." oninput="filterPermanentPayslip(this.value)">
        </div>
    </div>
</div>
