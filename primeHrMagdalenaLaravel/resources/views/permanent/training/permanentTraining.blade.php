...
<div class="app-layout">
    ...
    {{-- Main Content --}}
    <main class="main-content permanent-dashboard permanent-training">
        ...
        <div class="table-section">
            <div class="table-header">
                ...
                <div class="table-wrapper">
                    <table class="payroll-table training-my-table">
                        <thead>
                            <tr>
                                <th>Training ID</th>
                                <th>Program Title</th>
                        ...
                        <tbody>
                            <tr>
                                <td class="training-table-id">TRN-001</td>
                                <td class="position-cell">Leadership Development Program</td>
                                <td><span class="type-badge leadership">Leadership</span></td>
                                <td class="training-table-date">Jun 15, 2025</td>
                                <td class="training-table-date">Jul 15, 2025</td>
                                <td>
                                    <div class="training-progress-row">
                                        <div class="training-progress-track"><div class="training-progress-fill training-progress-65 training-progress-fill-warning"></div></div>
                                        <span class="training-progress-pct">65%</span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="training-table-id">TRN-003</td>
                                <td class="position-cell">Customer Service Excellence</td>
                                <td><span class="type-badge soft-skills">Soft Skills</span></td>
                                <td class="training-table-date">May 10, 2025</td>
                                <td class="training-table-date">May 20, 2025</td>
                                <td>
                                    <div class="training-progress-row">
                                        <div class="training-progress-track"><div class="training-progress-fill training-progress-100 training-progress-fill-success"></div></div>
                                        <span class="training-progress-pct">100%</span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="training-table-id">TRN-002</td>
                                <td class="position-cell">Digital Literacy Training</td>
                                <td><span class="type-badge technical">Technical</span></td>
                                <td class="training-table-date">Apr 5, 2025</td>
                                <td class="training-table-date">Apr 15, 2025</td>
                                <td>
                                    <div class="training-progress-row">
                                        <div class="training-progress-track"><div class="training-progress-fill training-progress-100 training-progress-fill-success"></div></div>
                                        <span class="training-progress-pct">100%</span>
        ...
        <div class="table-section">
            ...
            <div class="training-cards">
                    <div class="training-card">
                        ...
                        <div class="card-icon training-card-icon-success">13</div>
                            <div>
                        ...
                        <div class="capacity-bar">
                            <div class="capacity-label">
                                <span>CAPACITY</span>
                                <span class="capacity-filled capacity-filled-success">48% filled</span>
                            </div>
                            <div class="progress-bar">
                                <div class="progress-fill training-capacity-fill training-capacity-48 training-capacity-fill-success"></div>
                            </div>
                        </div>
                    ...
                    <div class="training-card">
                        ...
                        <div class="card-header">
                        <div class="card-icon training-card-icon-danger">10</div>
                            <div>
                        ...
                        <div class="capacity-bar">
                            <div class="capacity-label">
                                <span>CAPACITY</span>
                                <span class="capacity-filled capacity-filled-danger">80% filled</span>
                            </div>
                            <div class="progress-bar">
                                <div class="progress-fill training-capacity-fill training-capacity-80 training-capacity-fill-danger"></div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <div>
...
{{-- Fully Booked Modal --}}
<div class="modal-overlay" id="fullyBookedModal" onclick="closeModal('fullyBookedModal')">
    <div class="modal-box training-modal-sm" onclick="event.stopPropagation()">
        <div class="modal-body training-modal-center">
            <div class="training-modal-icon training-modal-icon-danger">
            ...
            <h3 class="modal-title training-modal-title-gap">Training Fully Booked</h3>
            <p class="training-modal-text">Sorry, this training program has <strong>no available slots</strong>. Please check back later or choose another program.</p>
            <div class="training-modal-alert training-modal-alert-danger">
                <div class="modal-row training-modal-row-danger"><span>Status</span><strong class="training-danger-strong">Fully Booked</strong></div>
                <div class="modal-row training-modal-row-last"><span>Suggestion</span><strong>Try another program</strong></div>
            </div>
        </div>
        <div class="modal-footer training-modal-footer-center">
            <button class="modal-btn-primary training-modal-btn-full" onclick="closeModal('fullyBookedModal')">Got It</button>
        </div>
    </div>
</div>

{{-- Certificate Download Modal --}}
<div class="modal-overlay" id="certDownloadModal" onclick="closeModal('certDownloadModal')">
    <div class="modal-box training-modal-sm" onclick="event.stopPropagation()">
        <div class="modal-body training-modal-center">
            ...
            <h3 class="modal-title training-modal-title-gap">Certificate Downloaded!</h3>
            <p class="training-modal-text">Your certificate of completion has been successfully downloaded as a PDF file.</p>
            <div class="training-modal-meta">
                ...
                <div class="modal-row training-modal-row-last"><span>Downloaded</span><strong id="cdDate">&mdash;</strong></div>
            </div>
        </div>
        <div class="modal-footer training-modal-footer-center">
            <button class="modal-btn-ghost training-modal-btn-half" onclick="closeModal('certDownloadModal')">Close</button>
            <button class="modal-btn-primary training-modal-btn-half" onclick="closeModal('certDownloadModal')">
...
<div class="modal-overlay" id="enrollConfirmModal" onclick="closeModal('enrollConfirmModal')">
    <div class="modal-box training-modal-md" onclick="event.stopPropagation()">
        ...
        <div class="modal-body">
            <div class="training-enroll-details">
                <p class="training-enroll-label">TRAINING DETAILS</p>
                ...
                <div class="modal-row training-modal-row-last"><span>Venue</span><strong id="ecVenue">—</strong></div>
            </div>
            <div class="training-enroll-note">
                ...
                <p class="training-enroll-note-text">Once submitted, your enrollment request will be reviewed by the HRMO. You will be notified upon approval.</p>
            </div>
        </div>
...
<div class="modal-overlay" id="enrollSuccessModal" onclick="closeModal('enrollSuccessModal')">
    <div class="modal-box training-modal-sm" onclick="event.stopPropagation()">
        <div class="modal-body training-modal-center">
            <div class="training-modal-icon training-modal-icon-success">
            ...
            <h3 class="modal-title training-modal-title-gap">Enrollment Submitted!</h3>
            <p class="training-modal-text">Your enrollment request for <strong id="esTitle">—</strong> has been submitted and is pending HRMO approval.</p>
            <div class="training-modal-meta">
                <div class="modal-row"><span>Reference No.</span><strong id="esRef">—</strong></div>
                <div class="modal-row"><span>Status</span><strong class="training-pending-strong">Pending Approval</strong></div>
                <div class="modal-row training-modal-row-last"><span>Submitted</span><strong id="esDate">—</strong></div>
            </div>
        </div>
        <div class="modal-footer training-modal-footer-center">
            <button class="modal-btn-primary training-modal-btn-full" onclick="closeModal('enrollSuccessModal')">Done</button>
        </div>
    </div>
</div>

{{-- Training Modal --}}
<div class="modal-overlay" id="trainingModal" onclick="closeModal('trainingModal')">
    <div class="modal-box" onclick="event.stopPropagation()">
        <div class="modal-header">
            <div class="pmodal-hero">
                <div class="pmodal-hero-icon" id="modalIcon">
