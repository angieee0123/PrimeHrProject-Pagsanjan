            ...
            <div class="wizard-content" data-step="2" style="display:none;">
                <div id="step2-register">
                    ...
                    <div class="wizard-info-box">
                        ...
                        <p class="wizard-info-text">Set up the username and email — the password is generated for you</p>
                    </div>
                    ...
                    {{-- The admin does not choose the password, so there is no
                         field for one. It is generated by the server
                         (TemporaryPasswordService) and mailed to the address
                         above — the field was removed because a hand-typed
                         password is reused, guessable, and known to whoever
                         created the account. The length is read off the
                         generator rather than written here, so this sentence
                         cannot promise one the generator does not produce. --}}
                    <div class="wizard-field">
                        <label class="wizard-label-text">Password</label>
                        <div class="wizard-info-box wizard-pw-notice">
                            <p class="wizard-info-title"><svg class="wizard-info-icon" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg><strong>Generated and emailed automatically</strong></p>
                            <p class="wizard-info-text">A random {{ \App\Services\TemporaryPasswordService::LENGTH }}-character password is created when this form is submitted and sent to the email address above by the system's email sender. It is not shown here or to you, so that address has to be right — the email is the employee's only copy.</p>
                        </div>
                    </div>
                    <div class="wizard-field">
