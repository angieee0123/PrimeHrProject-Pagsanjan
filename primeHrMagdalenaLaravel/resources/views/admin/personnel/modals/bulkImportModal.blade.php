    ...
    <div style="background:#fff; border-radius:20px; width:100%; max-width:600px; box-shadow:0 20px 50px rgba(15,23,42,.16), 0 2px 10px rgba(15,23,42,.05);">
        <div style="padding:24px; border-bottom:1.5px solid var(--gp-bg-tint-2);">
            <div style="display:flex; justify-content:space-between; align-items:flex-start;">
                <div>
                    <h3 style="margin:0 0 4px; font-size:18px; font-weight:700; color:var(--gp-pri);">Bulk Import Employees</h3>
                    <p style="margin:0; font-size:13px; color:var(--gp-text-mid);">Upload a CSV file to import multiple employees at once</p>
                </div>
                <button onclick="closeBulkImportModal()" style="background:none; border:none; border-radius:9px; font-size:28px; color:var(--gp-text-mid); cursor:pointer; width:32px; height:32px; display:flex; align-items:center; justify-content:center; transition:background .2s cubic-bezier(.4,0,.2,1);">&times;</button>
            </div>
        </div>
        ...
        <div style="padding:24px;">
            ...
            <form id="bulkImportForm" enctype="multipart/form-data">
                ...
                <div style="margin-bottom:20px;">
                    ...
                    <div id="dropZone" style="border:2px dashed var(--theme-neutral-300); border-radius:14px; padding:32px; text-align:center; cursor:pointer; transition:border-color .2s cubic-bezier(.4,0,.2,1), background .2s cubic-bezier(.4,0,.2,1); background:var(--gp-bg-tint);">
                    ...
                    <div id="fileInfo" style="display:none; margin-top:12px; padding:12px; background:#e9f9ef; border:1.5px solid #c8f0d8; border-radius:9px;">
                        <div style="display:flex; align-items:center; justify-content:space-between;">
                            <div style="display:flex; align-items:center; gap:10px;">
                                ...
                                <div>
                                    <p id="fileName" style="margin:0; font-size:13px; font-weight:600; color:var(--theme-success);"></p>
                                    <p id="fileSize" style="margin:0; font-size:11px; color:var(--theme-success);"></p>
                                </div>
                            </div>
                            <button type="button" onclick="removeFile()" style="background:none; border:none; border-radius:8px; color:var(--theme-danger); cursor:pointer; padding:4px; transition:background .2s cubic-bezier(.4,0,.2,1);">
        ...
        <div style="display:flex; justify-content:flex-end; gap:10px; padding:16px 24px; border-top:1.5px solid var(--gp-bg-tint-2);">
            <button onclick="closeBulkImportModal()" style="padding:10px 20px; border:1.5px solid var(--theme-neutral-300); border-radius:9px; background:#fff; font-size:13px; font-weight:600; color:var(--gp-text-mid); cursor:pointer; font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display','SF Pro Text','Helvetica Neue',Arial,sans-serif; transition:background .2s cubic-bezier(.4,0,.2,1);">Cancel</button>
            <button onclick="submitBulkImport()" style="padding:10px 20px; border:none; border-radius:9px; background:linear-gradient(135deg,var(--gp-pri),var(--gp-pri-2)); color:#fff; font-size:13px; font-weight:600; cursor:pointer; font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display','SF Pro Text','Helvetica Neue',Arial,sans-serif; display:flex; align-items:center; gap:6px; transition:transform .15s ease;">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/>
                    <polyline points="17 8 12 3 7 8"/>
                    <line x1="12" y1="3" x2="12" y2="15"/>
