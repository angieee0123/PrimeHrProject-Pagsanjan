...
{{-- ============ SEGMENTED TABS ============ --}}
{{-- `data-tab` names each button for switchTab(), which normally finds the
     button through the click event but has to be able to reach it when
     something else switches tabs programmatically -- the topbar search brings
     the Summary tab forward, because that is the table it filters. --}}
<div class="seg-tabs">
    <button class="tab-btn active" data-tab="summary" onclick="switchTab('summary')">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
        Attendance Summary
    </button>
    <button class="tab-btn" data-tab="detailed" onclick="switchTab('detailed')">
