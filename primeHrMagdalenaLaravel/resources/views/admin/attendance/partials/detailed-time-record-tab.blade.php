<section class="table-section" id="detailed-tab">
    ...
    <div class="table-header">
        ...
        <div class="table-actions">
            ...
            {{-- A plain link, not a JS handler: the endpoint answers with a
                 Content-Disposition attachment, so the browser downloads the
                 CSV without the page navigating away. It carries the tab's
                 current filters (and only those), so "Export All" means every
                 day the timeline is filtered to -- not just the page shown. --}}
            <a class="btn-export"
               href="{{ route('admin.attendance.detailed.export-all', array_filter([
