<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        $navItems = [
            ...
            ['label' => 'Deductions', 'id' => 'deductions', 'route' => 'admin.deductions'],
        ...
        <a href="{{ $item['route'] === '#' ? '#' : route($item['route']) }}"
           ...
           title="{{ $item['label'] }}">
            <span class="nav-icon">
                ...
                @elseif($item['id'] === 'deductions')
                <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/><path d="M12 14h.01"/></svg>
