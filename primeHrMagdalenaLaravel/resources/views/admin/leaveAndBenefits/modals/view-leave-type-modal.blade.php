<x-modal id="viewLeaveTypeModal" close="closeViewLeaveTypeModal" title="-" title-id="viewLeaveName" subtitle="Leave Type Configuration">
    <x-slot:eyebrow>LEAVE TYPE · <span id="viewLeaveCode">-</span></x-slot:eyebrow>
    <div class="modal-body">
        ...
        <div id="viewAttachmentInfoGroup" style="display: none; margin-top: 16px;">
            ...
            <p id="viewAttachmentInfo" style="font-size: 13px; color: var(--gp-text-mid); line-height: 1.6; margin: 8px 0;">-</p>
        </div>
