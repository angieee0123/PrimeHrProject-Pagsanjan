<x-topbar title="Pass Slip Management">
    ...
    <x-slot:actions>
        <div class="topbar-search-wrap">
            ...
            <input type="text" id="passSlipSearchInput" class="topbar-search-input" placeholder="Search by employee or reason..." oninput="searchPassSlips(this.value)">
        </div>
    </x-slot:actions>
</x-topbar>
