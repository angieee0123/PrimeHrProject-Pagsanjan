...
<x-modal id="payslipDetailModal" container-class="modal-container" box-style="max-width: 800px;" close="closePayslipModal" title="Payslip Details">
    ...
    <div class="modal-body">
        ...
        <div class="payslip-footer">
            ...
            <div class="notes-info pr-hidden" id="modalNotesSection">
                <label>Notes:</label>
                <p id="modalNotes">-</p>
            </div>
        </div>
...
@push('scripts')
    @vite('resources/js/admin/payroll/payslip-detail-modal.js')
@endpush
