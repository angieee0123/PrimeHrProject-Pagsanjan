        ...
        <tbody id="payslipsTableBody">
            ...
            <tr data-status="{{ $computation->status }}">
                ...
                <td class="row-menu-cell">
                    <button type="button" class="row-menu-btn" data-menu="payslipMenu{{ $computation->id }}"
                    ...
                    <div class="row-menu" id="payslipMenu{{ $computation->id }}" role="menu" aria-label="Payslip actions">
                        <button type="button" role="menuitem" class="row-menu-item" onclick="closeRowMenu(); viewPayslipDetail({{ $computation->id }})">
                        ...
                        <button type="button" role="menuitem" class="row-menu-item" onclick="closeRowMenu(); printPayslipDirect({{ $computation->id }})">
                ...
                @if($computation->status === 'pending' || $computation->status === 'draft')
                        ...
                        <button type="button" role="menuitem" class="row-menu-item is-accept" onclick="closeRowMenu(); approvePayslip({{ $computation->id }})">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                            Approve
                        </button>
                        <button type="button" role="menuitem" class="row-menu-item is-danger" onclick="closeRowMenu(); rejectPayslip({{ $computation->id }})">
