{{-- Stats --}}
<div class="stats-grid stats-grid-4 dep-stats-grid">
    <div class="stat-card">
        <div class="stat-top">
            <p class="stat-label">Total Departments</p>
            <div class="stat-icon-wrap dep-icon-purple">
        ...
        <div class="stat-footer">
            <span class="stat-dot dep-dot-purple"></span>
    ...
    <div class="stat-card">
        <div class="stat-top">
            ...
            <div class="stat-icon-wrap dep-icon-green">
        ...
        <div class="stat-footer">
            <span class="stat-dot dep-dot-green"></span>
    ...
    <div class="stat-card">
        <div class="stat-top">
            ...
            <div class="stat-icon-wrap dep-icon-yellow">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
            </div>
        </div>
        <h2 class="stat-value">{{ $activeDepts }}</h2>
        <div class="stat-footer">
            <span class="stat-dot dep-dot-yellow"></span>
    ...
    <div class="stat-card">
        <div class="stat-top">
            ...
            <div class="stat-icon-wrap dep-icon-red">
        ...
        <div class="stat-footer">
            <span class="stat-dot dep-dot-red"></span>
