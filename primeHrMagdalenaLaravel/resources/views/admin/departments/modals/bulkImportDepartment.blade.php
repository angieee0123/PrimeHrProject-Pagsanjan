        ...
        <div class="adm-body">
            ...
            <div style="background:#f0fdf4;border:1.5px solid #bbf7d0;border-radius:10px;padding:16px 18px;margin-bottom:16px;display:flex;align-items:center;justify-content:space-between;gap:12px;">
                <div style="display:flex;align-items:center;gap:12px;">
                    ...
                    <div>
                        ...
                        <p style="font-size:12px;color:#56547a;">Use the CSV template to fill in your department data correctly.</p>
                    </div>
                </div>
            ...
            <form method="POST" action="{{ route('admin.departments.import') }}" enctype="multipart/form-data" id="bulk-import-form">
                ...
                <div style="background:#f7f6fc;border-radius:10px;padding:14px 16px;margin-top:4px;">
                    ...
                    <p style="font-size:11px;color:#8f8daf;margin-top:8px;">status must be <strong>Active</strong> or <strong>Inactive</strong> · description is optional</p>
                </div>
