<div id="bulk-import-modal" class="adm-overlay" onclick="closeBulkImportModal()">
    <div class="adm-box" onclick="event.stopPropagation()">
        ...
        <div class="adm-header">
            <div class="adm-header-left">
                ...
                <div>
                    <span class="adm-eyebrow">DEPARTMENTS · BULK IMPORT</span>
                    <h3 class="adm-title">Import Departments</h3>
                </div>
            </div>
            <button class="adm-close" onclick="closeBulkImportModal()">
        ...
        <div class="adm-body">
            ...
            <div style="background:#f0fdf4;border:1.5px solid #bbf7d0;border-radius:10px;padding:16px 18px;margin-bottom:16px;display:flex;align-items:center;justify-content:space-between;gap:12px;">
                <div style="display:flex;align-items:center;gap:12px;">
                    ...
                    <div>
                        ...
                        <p style="font-size:12px;color:#6b6a8a;">Use the CSV template to fill in your department data correctly.</p>
                    </div>
                </div>
                <a href="{{ route('admin.departments.template') }}" class="adm-btn-ghost" style="white-space:nowrap;text-decoration:none;display:flex;align-items:center;gap:6px;font-size:12.5px;">
            ...
            <form method="POST" action="{{ route('admin.departments.import') }}" enctype="multipart/form-data" id="bulk-import-form">
                ...
                <div class="adm-field">
                    ...
                    <div id="drop-zone" style="border:2px dashed #c7c5e8;border-radius:10px;padding:28px;text-align:center;cursor:pointer;transition:border-color .2s;" onclick="document.getElementById('csv-file-input').click()" ondragover="event.preventDefault();this.style.borderColor='#0b044d'" ondragleave="this.style.borderColor='#c7c5e8'" ondrop="handleDrop(event)">
                        ...
                        <p style="font-size:13px;font-weight:600;color:#0b044d;margin-bottom:4px;" id="drop-label">Drag & drop your CSV here</p>
                        <p style="font-size:12px;color:#9999bb;">or click to browse · .csv files only</p>
                    </div>
                    <input type="file" id="csv-file-input" name="csv_file" accept=".csv" style="display:none;" onchange="handleFileSelect(this)">
                </div>
                ...
                <div style="background:#f7f6ff;border-radius:10px;padding:14px 16px;margin-top:4px;">
                    ...
                    <p style="font-size:11px;color:#9999bb;margin-top:8px;">status must be <strong>Active</strong> or <strong>Inactive</strong> · description is optional</p>
                </div>
                ...
                <div class="adm-footer" style="margin-top:16px;padding:0;">
                    ...
                    <button type="submit" class="adm-btn-primary" style="background:#15803d;" id="import-submit-btn" disabled>
...
<script>
function openBulkImportModal()  { document.getElementById('bulk-import-modal').classList.add('open');  document.body.style.overflow = 'hidden'; }
function closeBulkImportModal() { document.getElementById('bulk-import-modal').classList.remove('open'); document.body.style.overflow = ''; }
