                ...
                <tr data-employee="{{ strtolower($loan->employee->first_name . ' ' . $loan->employee->last_name) }}"
                    ...
                    <td class="lt-c-actions">
                        ...
                        <div class="lt-menu" id="loanMenu{{ $loan->id }}" role="menu" aria-label="Loan actions">
                            ...
                            <button type="button" role="menuitem" class="lt-menu-item is-danger" onclick="closeLoanMenu(); deleteEmployeeDeduction({{ $loan->id }}, '{{ $loan->employee->first_name }} {{ $loan->employee->last_name }}', '{{ $loan->deductionType->name }}')">
                                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
