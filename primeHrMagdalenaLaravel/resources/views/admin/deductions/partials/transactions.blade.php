<div class="table-header" style="margin-bottom: 16px;">
    <div>
        <h3 class="table-title" style="font-size: 16px; margin-bottom: 4px;">Deduction Transactions</h3>
        <p class="table-sub">View complete history of all deduction transactions</p>
    </div>
