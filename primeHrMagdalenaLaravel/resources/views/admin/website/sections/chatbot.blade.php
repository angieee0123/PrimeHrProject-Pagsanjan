...
{{-- The public widget is answered by the HRIS AI Assistant, limited to
...
<div class="wc-callout">
    ...
    <div><strong>Answers come from the HRIS AI Assistant, limited to public information.</strong> Visitors can ask how-to and HR policy questions — grace periods, leave types, how to file a leave — and general questions. They cannot see any employee records, attendance, payroll, or uploaded files. Only the wording above is controlled here.</div>
</div>
