...
@include('mayor.travelOrder.partials.pending-orders-tab')

@include('mayor.travelOrder.partials.approved-orders-tab')

@include('mayor.travelOrder.partials.disapproved-orders-tab')
