...
CREATE TABLE `employment_details` (
  ...
  KEY `employment_details_designation_id_foreign` (`designation_id`),
  ...
  CONSTRAINT `employment_details_designation_id_foreign` FOREIGN KEY (`designation_id`) REFERENCES `designations` (`id`) ON DELETE SET NULL,
...
INSERT INTO `employment_details` VALUES (5,6,NULL,5,'Permanent','2026-01-01',NULL,'1'),(6,8,2,1,'Permanent','2026-01-01',NULL,NULL),(7,9,6,1,'Permanent','2026-01-01',NULL,NULL),(8,10,5,1,'Permanent','2026-01-01',NULL,NULL),(9,11,NULL,1,'Permanent','2026-01-01',NULL,NULL),(10,12,94,18,'Permanent','2026-01-01',NULL,NULL),(11,13,NULL,1,'Permanent','2026-01-01',NULL,NULL),(12,14,NULL,1,'Permanent','2026-01-01',NULL,NULL),(13,15,NULL,4,'Permanent','2026-01-01',NULL,NULL),(14,16,NULL,5,'Permanent','2026-01-01',NULL,NULL),(15,17,NULL,3,NULL,'2026-01-01',NULL,NULL),(16,18,92,17,'Permanent','2026-05-24',NULL,NULL);
...
-- Dump completed on 2026-06-23 15:42:28
