...
CREATE TABLE `employee_requests` (
  ...
  PRIMARY KEY (`id`),
  KEY `employee_requests_processed_by_foreign` (`processed_by`),
  KEY `employee_requests_employee_id_status_index` (`employee_id`,`status`),
  KEY `employee_requests_created_at_index` (`created_at`),
  CONSTRAINT `employee_requests_employee_id_foreign` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`) ON DELETE CASCADE,
  CONSTRAINT `employee_requests_processed_by_foreign` FOREIGN KEY (`processed_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
...
-- Dump completed on 2026-05-24 13:06:18
