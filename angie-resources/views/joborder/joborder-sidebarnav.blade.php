@php
$navItems = [
    ['id' => 'dashboard',   'label' => 'Dashboard',              'route' => '/joborder/dashboard'],
    ['id' => 'payslip',     'label' => 'Payslip',                'route' => '/joborder/payslip'],
    ['id' => 'attendance',  'label' => 'Attendance',             'route' => '/joborder/attendance'],
    ['id' => 'training',    'label' => 'Training',               'route' => '/joborder/training'],
    ['id' => 'performance', 'label' => 'Performance',            'route' => '/joborder/performance'],
    ['id' => 'profile',     'label' => 'Profile',                'route' => '/joborder/profile'],
    ['id' => 'settings',    'label' => 'Settings',               'route' => '/joborder/settings'],
];
...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-footer" id="sidebar-footer">
        ...
        <div class="user-info" id="user-info">
            <p class="user-name">Juan D. Cruz</p>
