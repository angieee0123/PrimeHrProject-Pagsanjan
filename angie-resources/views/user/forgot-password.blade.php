...
<div class="auth-root">
    ...
    <div class="auth-body">
        ...
        <div class="fp-steps">
            @foreach([1,2,3] as $s)
            <div class="fp-step-wrap{{ $s === 3 ? ' fp-step-last' : '' }}">
        ...
        <div class="auth-tags">
            <span class="pub-tag">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#15803d" stroke-width="2.5" style="display:inline-block;vertical-align:middle;margin-right:4px"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                Secure Recovery
            </span>
            <span class="pub-tag">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#15803d" stroke-width="2.5" style="display:inline-block;vertical-align:middle;margin-right:4px"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                Encrypted
            </span>
            <span class="pub-tag">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#15803d" stroke-width="2.5" style="display:inline-block;vertical-align:middle;margin-right:4px"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                Email Verified
            </span>
        </div>
...
const checkSVG = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.5"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>';
...
function goStep(n) {
    [1,2,3].forEach(s => {
        ...
        const numEl = document.getElementById('step-num-' + s);
        if (s < n) { numEl.innerHTML = checkSVG; }
